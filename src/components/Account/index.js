...
const Account = props => {
  ...
  const Length = localStorage.getItem('password').length
  const fontAccount = 'fontAccount'
  localStorage.setItem('font', fontAccount)
  return (
    <>
      <div>
        <Link to="/">
      ...
      <div className="container-acc">
        <div className="acc">
          ...
          <div className="address-container">
            ...
            <p className="gmail">{localStorage.getItem('user')}@gmail.com</p>
            <p className="passwordUser">Password : {`${'*'.repeat(Length)}`}</p>
            <hr className="hr2" />
            <span className="planDetails">Plan details</span>
            <div className="pre-container">
              <span className="premium">premium</span>
              <span className="ultra">Ultra HD</span>
            </div>
            <hr className="hr3" />
            <button
